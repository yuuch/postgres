...
public:
    ...
    PhysicalTableScan(TableIndex table_index, int pg_rtindex, std::string table_name,
        ...
        : PhysicalOperator(PhysicalOperatorType::TABLE_SCAN, estimated_cardinality),
          table_index(table_index), pg_rtindex(pg_rtindex), table_name(std::move(table_name)),
