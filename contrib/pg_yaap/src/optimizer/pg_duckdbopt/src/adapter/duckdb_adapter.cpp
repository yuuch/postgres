...
std::unique_ptr<LogicalOperator> BuildDependentJoin(DuckDBAdapter& adapter,
...
DuckDBAdapter::DuckDBAdapter(DuckDBAdapter* parent)
    : parent_(parent) {}

::RangeTblEntry* DuckDBAdapter::GetRte(int rtindex) {
...
::RangeTblEntry* DuckDBAdapter::GetRte(::Var* var) {
    if (!var) {
...
std::string DuckDBAdapter::GetRteName(int rtindex) {
...
std::string DuckDBAdapter::GetRteName(::Var* var) {
...
std::string DuckDBAdapter::GetColumnName(::Var* var) {
    if (var->varattno <= 0) {
        return "ctid";
    }
...
TableIndex DuckDBAdapter::GenerateTableIndex() {
    return TableIndex{next_table_index_++};
}

ColumnBinding DuckDBAdapter::BindBaseColumn(::Var* var) {
...
ColumnBinding DuckDBAdapter::GetBaseColumnBinding(::Var* var) {
    return BindBaseColumn(var);
}

size_t DuckDBAdapter::EstimateBaseCardinality(::RangeTblEntry* rte) {
...
void DuckDBAdapter::RegisterOutputBindings(int rtindex, ::RangeTblEntry* rte, LogicalOperator* plan) {
    if (!rte || !plan) {
        return;
    }
...
void DuckDBAdapter::PropagateUnaryCardinality(LogicalOperator& op) {
    if (op.children.size() == 1) {
        op.estimated_cardinality = op.children[0]->estimated_cardinality;
    }
}

void DuckDBAdapter::PropagateCrossProductCardinality(LogicalCrossProduct& op) {
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslateFromExprList(::List* fromlist) {
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslateFromNode(::Node* pg_node) {
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslateSetOperation(::Query* pg_query, ::Node* setop_node) {
    if (!setop_node) {
...
std::unique_ptr<Expression> DuckDBAdapter::TranslateExpression(::Node* pg_expr) {
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslateAggregate(::Query* pg_query,
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslateHaving(::Query* pg_query,
                                                                std::unique_ptr<LogicalOperator> input) {
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslateWindow(::Query* pg_query,
                                                                std::unique_ptr<LogicalOperator> input) {
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslateProjection(::Query* pg_query,
                                                                    std::unique_ptr<LogicalOperator> input) {
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslateDistinct(::Query* pg_query,
                                                                  std::unique_ptr<LogicalOperator> input) {
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslateOrder(::Query* pg_query,
                                                               std::unique_ptr<LogicalOperator> input) {
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslateLimit(::Query* pg_query,
                                                               std::unique_ptr<LogicalOperator> input) {
...
std::unique_ptr<LogicalOperator> DuckDBAdapter::TranslatePGQuery(::Query* pg_query) {
