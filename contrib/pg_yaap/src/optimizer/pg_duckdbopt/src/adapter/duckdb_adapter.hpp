...
// Adapts PostgreSQL's Query tree to duckdbopt LogicalOperator tree
class DuckDBAdapter {
public:
    explicit DuckDBAdapter(DuckDBAdapter* parent = nullptr);
    ~DuckDBAdapter() = default;
